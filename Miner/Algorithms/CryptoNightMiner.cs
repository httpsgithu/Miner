...
""wallet_address"" : """);
      ...
      if (string.IsNullOrEmpty(Miner.instance.settings.minerConfig.workerName) == false)
      {
        builder.Append(@".");
        builder.Append(Miner.instance.settings.minerConfig.workerName);
      }
      builder.Append(@""",
""pool_password"" : ""x"",
...
");
      ...
      File.WriteAllText(minerConfigFilename, builder.ToString());
    }
