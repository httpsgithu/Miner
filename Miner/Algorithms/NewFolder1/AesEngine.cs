...
namespace HD
{
  ...
  * </p>
  */
  public unsafe sealed class AesEngine
  {
    #region Data
    // The S box
    static readonly byte[] S =
   {
    ...
    /// <summary>
    ///  TODO perf - crazy idea, use unsafe array so no out of bounds checking
    /// </summary>
    // precomputation tables of calculations for rounds
    static readonly uint[] T0d =
    {
    ...
    static readonly uint[] T8 = new uint[]
    {
    ...
    static readonly uint[] T16 = new uint[]
    {
    ...
    static readonly uint[] T24 = new uint[]
    {
       ...
       uint* data)
    {
      ...
      {
        fixed (uint* keyData = WorkingKey[key]) // TODO perf
        {
    ...
    #region Helpers
    static unsafe void EncryptBlock(
      uint* kw,
      uint* data)
    {
      fixed (uint* T0 = T0d) // TODO perf we may be able to find a win here
      {
        uint tempdata3
          = T0[data[3] & 255]
            ^ T24[(data[0] >> 8) & 255]
